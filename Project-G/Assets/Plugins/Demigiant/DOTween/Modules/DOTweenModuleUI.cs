...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        public static TweenerCore<float, float, FloatOptions> DOFade(this VideoPlayer target, float endValue, float duration)
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To(() => target.targetCameraAlpha, x => target.targetCameraAlpha = x, endValue, duration);
            t.SetTarget(target);
            return t;
        }
